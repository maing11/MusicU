...
//    let numberOfPlays: Int
    ...
    static func fetchRecommendForYouSongs() -> [Song] {
        return [
            Song(title: "I'm a mess", artist: "Bebe Rexha", album: "Expectations", thumbnailUrl: Temporary.RCSong4, file: File(name: "SeeYouAgain", type: FileType.mp3.rawValue)),
            Song(title: "Yummy", artist: "Justin Bieber", album: "Unknow", thumbnailUrl: Temporary.RCSong5, file: File(name: "SeeYouAgain", type: FileType.mp3.rawValue)),
            Song(title: "2002", artist: "Anne Marie", album: "Speak Your Mind", thumbnailUrl: Temporary.RCSong3, file: File(name: "SeeYouAgain", type: FileType.mp3.rawValue)),
            Song(title: "Havana", artist: "Camila Cabello", album: "Camila", thumbnailUrl: Temporary.RCSong2, file: File(name: "SeeYouAgain", type: FileType.mp3.rawValue)),
            Song(title: "Memories", artist: "Adam Levine", album: "Unknow", thumbnailUrl: Temporary.RCSong1, file: File(name: "SeeYouAgain", type: FileType.mp3.rawValue)),
        ]
